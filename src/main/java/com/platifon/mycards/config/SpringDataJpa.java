 ...
 */
@Configuration
@EnableJpaRepositories("com.platifon.mycards.repositories")
@EnableJpaAuditing
@EnableTransactionManagement
@ComponentScan({"com.platifon.mycards.entity"})
@Slf4j
public class SpringDataJpa {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.platifon.mycards.entity");
